...
const ROLE_OPTIONS: Array<{ value: RoleType; label: string }> = [
  { value: "freelance_marketer", label: "I'm a freelance marketer" },
  { value: "marketing_agency_owner", label: "I own a marketing agency" },
  { value: "marketing_agency_employee", label: "I work in a marketing agency" },
  { value: "in_house_marketer", label: "I'm an in-house marketer for a brand" },
  { value: "small_business_owner", label: "I'm a small business owner" },
  { value: "other", label: "Other" },
];

const GOAL_OPTIONS: Array<{ value: GoalType; label: string }> = [
  {
    value: "publish_multiple_platforms",
    label: "Publish on multiple platforms",
  },
  {
    value: "manage_multiple_brands",
    label: "Manage multiple brands/locations",
  },
  {
    value: "implement_collaboration",
    label: "Implement a collaboration process",
  },
  { value: "approval_workflow", label: "Get approval before publishing" },
  { value: "visual_planning", label: "Visually plan content" },
  {
    value: "automate_content",
    label: "Automate content creation & publishing",
  },
  { value: "other", label: "Other" },
];
