 ...
 */
export async function createTestOrganization({ userId, name = faker.company.name(), onboardingRole = "small_business_owner", asAdmin = true, }) {
    ...
    if (orgError)
        throw orgError;
    if (!org)
        throw new Error("No organization data returned after insert");
