...
const getRequiredEnvVar = (key) => {
    ...
    if (!value) {
        console.error(`Environment variable ${key} is missing. Available vars:`, Object.keys(process.env).filter((k) => k.includes("RESEND") || k.includes("SITE") || k.includes("SUPABASE")));
