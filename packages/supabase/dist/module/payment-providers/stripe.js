 ...
 * ```
 */
export const createStripeClient = ({ apiKey, apiVersion = '2024-12-18.acacia', }) => {
 ...
 */
export const getOrCreateStripeAccount = async ({ supabase, stripe, ownerType, ownerId, email, name, metadata = {}, }) => {
    ...
    const { data: existingAccount } = await supabase
        ...
        .single();
    if (existingAccount) {
        const customer = await stripe.customers.retrieve(existingAccount.provider_customer_id);
        if (customer.deleted) {
 ...
 * ```
 */
export const addStripePaymentMethod = async ({ supabase, stripe, accountId, paymentMethodId, customerId, isDefault = false, }) => {
 ...
 * ```
 */
export const createStripeCheckoutSession = async ({ stripe, customerId, priceId, successUrl, cancelUrl, trialDays, metadata = {}, allowPromotionCodes = true, collectPhoneNumber = false, }) => {
    const params = {
        customer: customerId,
        mode: 'subscription',
 ...
 * ```
 */
export const createStripeBillingPortalSession = async ({ stripe, customerId, returnUrl, configuration, }) => {
 ...
 * ```
 */
export const createStripeUsageRecord = async ({ stripe, subscriptionItemId, quantity, timestamp = Math.floor(Date.now() / 1000), action = 'increment', }) => {
 ...
 */
export const constructStripeEvent = ({ stripe, payload, signature, webhookSecret, }) => {
 ...
 * ```
 */
export const getStripeCheckoutSession = async ({ stripe, sessionId, }) => {
 ...
 * ```
 */
export const getStripeSubscription = async ({ stripe, subscriptionId, }) => {
 ...
 * ```
 */
export const updateStripeSubscription = async ({ stripe, subscriptionId, params, }) => {
 ...
 * ```
 */
export const cancelStripeSubscription = async ({ stripe, subscriptionId, cancelAtPeriodEnd = true, }) => {
 ...
 * ```
 */
export const getStripeInvoice = async ({ stripe, invoiceId, }) => {
 ...
 * ```
 */
export const listStripeInvoices = async ({ stripe, customerId, limit = 10, startingAfter, }) => {
 ...
 * ```
 */
export const getStripeUpcomingInvoice = async ({ stripe, customerId, subscriptionId, }) => {
 ...
 * ```
 */
export const updateStripeSubscriptionItems = async ({ stripe, subscriptionId, items, }) => {
    return stripe.subscriptions.update(subscriptionId, {
 ...
 * ```
 */
export const previewStripeProration = async ({ stripe, subscriptionId, items, }) => {
    return stripe.invoices.retrieveUpcoming({
        subscription: subscriptionId,
 ...
 * ```
 */
export const applyStripeCoupon = async ({ stripe, subscriptionId, couponId, }) => {
    return stripe.subscriptions.update(subscriptionId, {
        coupon: couponId,
    });
};
 ...
 * ```
 */
export const removeStripeCoupon = async ({ stripe, subscriptionId, }) => {
    return stripe.subscriptions.update(subscriptionId, {
        coupon: undefined,
    });
};
 ...
 */
export const validateStripeCoupon = async ({ stripe, couponId, }) => {
 ...
 * ```
 */
export const createStripeSetupIntent = async ({ stripe, customerId, paymentMethodTypes = ['card'], }) => {
 ...
 * ```
 */
export const createStripePaymentIntent = async ({ stripe, customerId, amount, currency = 'usd', paymentMethodTypes = ['card'], metadata = {}, }) => {
 ...
 * ```
 */
export const createStripeBillingPortalConfig = async ({ stripe, businessName, returnUrl, features = {
    payment_method_update: { enabled: true },
    customer_update: {
        enabled: true,
        allowed_updates: ['email', 'name'],
 ...
 * ```
 */
export const createStripeCheckoutSessionOneTime = async ({ stripe, customerId, amount, currency = 'usd', name, description, successUrl, cancelUrl, metadata = {}, allowPromotionCodes = true, collectPhoneNumber = false, }) => {
