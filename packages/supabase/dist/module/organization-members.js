 ...
 * ```
 */
export async function createOrganizationMember({ supabase, member, }) {
    try {
        ...
        throw new OrganizationMemberOperationError("Create Organization Member", "Failed to create organization member", "Unable to create organization member. Please try again.", SupabaseErrorCode.CREATE_FAILED, error);
    }
}
/**
 ...
 * ```
 */
export async function getOrganizationMember({ supabase, memberId, }) {
    try {
        const { data, error } = await supabase
            .from("organization_members")
            .select("*")
        ...
        throw new OrganizationMemberOperationError("Get Organization Member", `Failed to retrieve organization member with ID: ${memberId}`, "Unable to load organization member details. Please refresh the page.", SupabaseErrorCode.READ_FAILED, error);
    }
}
/**
...
export async function getOrganizationMembers({ supabase, organizationId, }) {
    try {
        ...
        throw new OrganizationMemberOperationError("Get Organization Members", `Failed to retrieve members for organization: ${organizationId}`, "Unable to load organization members. Please refresh the page.", SupabaseErrorCode.READ_FAILED, error);
    }
}
/**
 ...
 * ```
 */
export async function updateOrganizationMember({ supabase, memberId, member, }) {
    try {
        const { data, error } = await supabase
            .from("organization_members")
            .update(member)
        ...
        throw new OrganizationMemberOperationError("Update Organization Member", `Failed to update organization member with ID: ${memberId}`, "Unable to update organization member. Please try again.", SupabaseErrorCode.UPDATE_FAILED, error);
    }
}
/**
 ...
 * ```
 */
export async function deleteOrganizationMember({ supabase, memberId, }) {
    try {
        ...
        throw new OrganizationMemberOperationError("Delete Organization Member", `Failed to delete organization member with ID: ${memberId}`, "Unable to delete organization member. Please try again.", SupabaseErrorCode.DELETE_FAILED, error);
    }
}
