...
import { getTeamMember, getTeamMembers, createTeamMember, updateTeamMember, deleteTeamMember, } from "./team-members";
/**
...
export const teamMemberKeys = {
    ...
    detail: (id) => ["team-members", "detail", id],
};
/**
...
export const teamMemberQueryKeys = {
    all: ["team-members"],
    lists: ["team-members", "list"],
    list: (filters) => ["team-members", "list", filters],
    details: ["team-members", "detail"],
    detail: (id) => ["team-members", "detail", id],
};
/**
 ...
 * ```
 */
export function useTeamMember({ memberId, supabase, options = {}, }) {
 ...
 * ```
 */
export function useTeamMembers({ teamId, supabase, options = {}, }) {
    return useQuery({
 ...
 * ```
 */
export function useCreateTeamMember({ supabase, options = {}, }) {
 ...
 * ```
 */
export function useUpdateTeamMember({ supabase, options = {}, }) {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: async ({ memberId, member }) => updateTeamMember({ supabase, memberId, member }),
        onSuccess: (data, variables, ctx) => {
            queryClient.invalidateQueries({
 ...
 * ```
 */
export function useDeleteTeamMember({ supabase, options = {}, }) {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: async ({ memberId }) => deleteTeamMember({ supabase, memberId }),
