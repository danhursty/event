 ...
 * ```
 */
export async function createTeamMember({ supabase, member, }) {
    try {
        ...
        throw new TeamMemberOperationError("Create Team Member", "Failed to create team member", "Unable to create team member. Please try again.", SupabaseErrorCode.CREATE_FAILED, error);
    }
}
/**
 ...
 * ```
 */
export async function getTeamMember({ supabase, memberId, }) {
    try {
        const { data, error } = await supabase
            .from("team_members")
            .select("*")
        ...
        throw new TeamMemberOperationError("Get Team Member", `Failed to retrieve team member with ID: ${memberId}`, "Unable to load team member details. Please refresh the page.", SupabaseErrorCode.READ_FAILED, error);
    }
}
/**
...
export async function getTeamMembers({ supabase, teamId, }) {
    try {
        ...
        throw new TeamMemberOperationError("Get Team Members", `Failed to retrieve members for team: ${teamId}`, "Unable to load team members. Please refresh the page.", SupabaseErrorCode.READ_FAILED, error);
    }
}
/**
 ...
 * ```
 */
export async function updateTeamMember({ supabase, memberId, member, }) {
    try {
        const { data, error } = await supabase
            .from("team_members")
            .update(member)
        ...
        throw new TeamMemberOperationError("Update Team Member", `Failed to update team member with ID: ${memberId}`, "Unable to update team member. Please try again.", SupabaseErrorCode.UPDATE_FAILED, error);
    }
}
/**
 ...
 * ```
 */
export async function deleteTeamMember({ supabase, memberId, }) {
    try {
        ...
        throw new TeamMemberOperationError("Delete Team Member", `Failed to delete team member with ID: ${memberId}`, "Unable to delete team member. Please try again.", SupabaseErrorCode.DELETE_FAILED, error);
    }
}
